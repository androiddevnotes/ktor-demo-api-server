...
object DatabaseConfig {
    fun init() {
        ...
        if (dbUrl != null && dbUrl.startsWith("postgres://")) {
            ...
            dbUser = System.getenv("DATABASE_USER") ?: dotenv["DATABASE_USER"]
                    ?: throw IllegalStateException("DATABASE_USER must be set")
            dbPassword = System.getenv("DATABASE_PASSWORD") ?: dotenv["DATABASE_PASSWORD"]
                    ?: throw IllegalStateException("DATABASE_PASSWORD must be set")
        }
